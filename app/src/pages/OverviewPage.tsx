  ...
  return (
    <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <section className="py-12 md:py-24 border-b border-line group">
        <div className="grid gap-8 border-b border-line pb-7 lg:grid-cols-12 lg:items-end mb-8 md:mb-14">
          <div className="lg:col-span-8">
        ...
        <div className="w-full bg-surface/40 border-y md:border border-line py-8 px-4 md:p-12 transition-all duration-500 overflow-hidden relative">
          ...
          <div className="relative max-w-4xl mx-auto flex flex-col items-center mt-4 md:mt-8 w-full overflow-x-auto pb-6">
            <div className="flex flex-row items-center md:items-start justify-between min-w-[600px] md:min-w-0 w-full gap-4 md:gap-2 relative py-6 px-4 md:px-0">
              ...
              <div className="flex flex-col items-center text-center z-10 relative w-32">
                <div className="grid size-20 md:size-24 place-items-center border border-accent/40 bg-accent/5 mb-3 md:mb-5 rounded-xl">
              ...
              {/* Access Point */}
              <div className="flex flex-col items-center text-center z-10 relative w-32">
                <div className="grid size-20 md:size-24 place-items-center border border-accent bg-accent mb-3 md:mb-5 relative rounded-xl">
              ...
              {/* Devices */}
              <div className="flex flex-col items-center text-center z-10 relative w-32">
                <div className="grid size-20 md:size-24 place-items-center border border-accent/40 bg-accent/5 mb-3 md:mb-5 relative rounded-xl">
